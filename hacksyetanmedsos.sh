...
echo $i" |"$cy"     "TEAMHACKERARMYINDONESIA"$i"                              |"
echo $i" |"$me"─────────────────────────────────────────────"$i"     |"
echo $i" |"$pu" AUTHOR :"$ku" MRLINKERRORSYSTEM  [FR13ND8]"$i"               |"
echo $i" |"$pu" WEBSITE :"$ku" MRLINKERRORSYSTEM@blogspot.com"$i"            |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.TCHA] [MR.JOKERERRORSYSTEM] [MR.R]"$i" |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [MRLINKERRORSYSTEM]"$i"        |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 081249281196"$i"                     |"
echo $i" |"$pu" Contack Email :"$ku" MRLINKERRORSYSTEM@Progammer.net"$i"     |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"MRLINKERRORSYSTEM"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"Website :"$i" mrlinkerrorsystem.blogspot.com"
echo $ku"Progammer :"$i" MRLINKERRORSYSTEM@progammer.net"
sleep 2
